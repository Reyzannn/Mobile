  ...
  class _KelolaProkerScreenState extends State<KelolaProkerScreen> {
    ...
    Future<void> _submit() async {
      ...
      try {
        ...
        if (_selectedImageData != null) {
          final fileName =
              'proker_${DateTime.now().millisecondsSinceEpoch}.jpg';
        ...
        } else if (widget.initialProker?.dokumentasi != null) {
          // Edit mode: pertahankan URL lama jika tidak ganti foto
          gambarUrl = widget.initialProker!.dokumentasi;
        }
        ...
        // Jika bisa pop (berarti dibuka sebagai sub-halaman), pop saja
        if (Navigator.of(context).canPop()) {
          Navigator.of(context).pop(true);
        } 
        // Jika tidak bisa pop (misal dibuka langsung dari sidebar), kembali ke /sekbid
        else {
          Navigator.pushNamedAndRemoveUntil(context, '/sekbid', (route) => false);
        }
      } catch (e) {
    ...
    Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        drawer: canPop
            ? null
            : SidebarWidget(activeMenu: 'proker', parentContext: context),
